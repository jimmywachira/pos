...
<body class="flex h-full min-h-screen flex-col bg-white text-slate-900 antialiased dark:bg-[#0a0d0c] dark:text-slate-100" font-family: 'Delius Unicase', cursive;>
