...
<footer class="text-black text-2xl  backdrop-blur" aria-labelledby="footer-heading">
    <h2 id="footer-heading" class="sr-only">Footer</h2>
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
            <div class="grid grid-cols-2 gap-8 xl:col-span-4 md:grid-cols-4">
                <div>
                    <h3 class=" font-semibold text-blue-600 tracking-wider uppercase">Solutions</h3>
                ...
                <div>
                    <h3 class="text-blue-600 font-semibold  tracking-wider uppercase">Support</h3>
                    <ul class="mt-4 space-y-4 text-base">
                ...
                <div class="mt-6 md:mt-0">
                    <h3 class="text-blue-600 font-semibold  tracking-wider uppercase">Company</h3>
                    <ul class="mt-4 space-y-4 text-base">
                ...
                <div class="mt-6 md:mt-0">
                    <h3 class="text-blue-600 font-semibold  tracking-wider uppercase">Legal</h3>
                    <ul class="mt-4 space-y-4 text-base">
            ...
            <div class="mt-6 xl:mt-0 xl:col-span-1">
                <h3 class="text-blue-600 font-semibold  tracking-wider uppercase">Subscribe to our newsletter</h3>
                <p class="mt-4 text-base ">The latest news, articles, and resources, sent to your inbox weekly.</p>
                <form class="mt-4 sm:flex sm:max-w-md">
                    <label for="email-address" class="sr-only">Email address</label>
                    <input type="email" name="email-address" id="email-address" autocomplete="email" required class="appearance-none min-w-0 w-full bg-white border border-transparent rounded-md py-2 px-4 text-xl uppercase text-gray-900 placeholder-black  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white focus:border-white focus:placeholder-gray-400" placeholder="Enter your email">
                    <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                        <button type="submit" class="w-full bg-blue-600 flex items-center justify-center border border-transparent rounded-md py-2 px-4 text-base font-medium  hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-blue-500">Subscribe</button>
                    </div>
                </form>
            </div>
        </div>
        <div class="mt-4 pt-4 md:flex md:items-center md:justify-between">
            ...
            <p class="mt-4 text-xl text-center  md:mt-0 md:order-1">&copy; {{ date('Y') }} DemoPOS, Inc. All rights reserved.</p>
        </div>
    </div>
</footer>
